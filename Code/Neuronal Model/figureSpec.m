function figureSpec(t,f,cdata1, fig, color)
%CREATEFIGURE(CDATA1)
%  CDATA1:  image cdata
...
% set(axes3,'YTickLabel',{num2str(floor(f(ticks(1)))) num2str(floor(f(ticks(2)))) num2str(floor(f(ticks(3)))) num2str(floor(f(ticks(4))))});
